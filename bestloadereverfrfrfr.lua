...
local Window = Library.CreateLib("mm2 (melhor doq alguns ai)", "Synapse") -- for different colors, use these: "GrapeTheme" "DarkTheme" "LightTheme" "BloodTheme" "Ocean" "Midnight" "Sentinel" "Synapse" "Serpent"
